...
public enum ClassType {
	...
	MINER("Miner", Armor.IRON, new PotionEffect(PotionEffectType.NIGHT_VISION, Integer.MAX_VALUE, 0), new PotionEffect(PotionEffectType.FAST_DIGGING, Integer.MAX_VALUE, 2), new PotionEffect(PotionEffectType.FIRE_RESISTANCE, Integer.MAX_VALUE, 0));
